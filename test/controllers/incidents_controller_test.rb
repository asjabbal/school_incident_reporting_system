...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { description: @incident.description, occurred_at: @incident.occurred_at, suspect_info: @incident.suspect_info, witness_info: @incident.witness_info } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { description: @incident.description, occurred_at: @incident.occurred_at, suspect_info: @incident.suspect_info, witness_info: @incident.witness_info } }
